     ...
     for row in reader:
         ...
         if LDR-valor_anterior>70:
             if Tiempo-tiempo_anterior>100000:
                 ...
                 "Tiempo paso por meta(s)":Tiempo/1000000, "Tiempo paso por meta(s) coche":Tiempo_paso,"Diferencia paso":abs(Tiempo/1000000 - Tiempo_paso),"Diferencia pasos":abs( abs(Tiempo/1000000 - Tiempo_paso) - Diferencia_paso),"Tiempo desde primer mensaje (s)":Tiempo/1000000-tiempo_inicio/1000000,
                 "LDR":LDR}
